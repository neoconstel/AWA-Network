            ...
            <div class="grid grid-rows-3 pl-24 pr-16 pt-10 text-gray-300">
                <div class="grid grid-cols-4 [&>*]:space-y-1 border-b-gray-500" style="border-bottom-width: 1px;">
                    <div>
                        ...
                        <p><img class="inline w-4 mr-1" src="/static/icons/iconmonstr-eye-lined.svg" alt=""><span
                                class="text-xs"><b>VIEWS</b></span>
                        </p>
                    </div>
                    <div>
                        <p class="text-2xl">234890</p>
                        <p><img class="inline w-4 mr-1" src="/static/icons/iconmonstr-thumb-10.svg" alt=""><span
